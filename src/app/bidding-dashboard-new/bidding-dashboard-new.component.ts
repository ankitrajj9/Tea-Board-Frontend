...
@Component({
  ...
  templateUrl: './bidding-dashboard-new.component.html',
  styleUrls: ['./bidding-dashboard-new.component.css']
})
export class BiddingDashboardNewComponent {
  userLoginId:any
  ...
  constructor(private auctionService: AuctionServiceService,private router: Router,private route:ActivatedRoute,private toastrService:ToastrService) { 
  ...
  public changeMaxBid(auctionItemDetailId:number){
    ...
    this.toastrService.error('Invalid Bid')
  }
  }
